...
export const fildesMenuArray: IFieldDialogData[] = [
  ...
  { label: 'checkbox'      , type: Types.checkbox     , img: 'assets/imgs/check.png'    , description: "Used to select many of items from group of items" },
  { label: 'checkbox Group', type: Types.checkboxGroup, img: 'assets/imgs/checklist.png', description: "Used to select many of items" },
  { label: 'radio'         , type: Types.radio        , img: 'assets/imgs/radio.png'    , description: "Used to select just one item using values ( Yes / No )" },
  { label: 'group of radio', type: Types.radioGroup   , img: 'assets/imgs/radiolist.png', description: "Used to select just one item from a group of radios using values ( Yes / No )" },
